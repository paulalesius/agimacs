...
- 1.1.1 [[*Garbage collection during boot][Garbage collection during boot]]
- 1.1.2 [[*Configure straight.][Configure straight.]]
- 1.1.3 [[*Startup stats][Startup stats]]
- 1.2 [[*Initialization (init.el)][Initialization (init.el)]]
- 1.2.1 [[*Package Manager][Package Manager]]
- 1.2.2 [[*Infrastructure][Infrastructure]]
- 1.2.3 [[*Completions][Completions]]
- 1.2.4 [[*Languages Common][Languages Common]]
- 1.2.5 [[*Python][Python]]
- 1.2.6 [[*Org Mode][Org Mode]]
- 1.2.7 [[*Editors][Editors]]
- 1.3 [[*Autotangle][Autotangle]]
#+END: toc
