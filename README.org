...
# BEGIN_TOC 3
- 1 [[*paulsemacs][Paul's Emacs]]
- 1.1 [[*earlyinitializationearlyinitel][Early Initialization (early-init.el)]]
- 1.1.1 [[*bootgc][Boot gc]]
- 1.1.2 [[*straightel][straight.el]]
- 1.1.3 [[*usepackageel][use-package.el]]
- 1.2 [[*initializationinitel][Initialization (init.el)]]
- 1.2.2 [[*infrastructure][Infrastructure]]
- 1.2.3 [[*completions][Completions]]
- 1.2.4 [[*languagescommon][Languages Common]]
- 1.2.5 [[*pythonmode][Python Mode]]
- 1.2.6 [[*rustmode][Rust Mode]]
- 1.2.7 [[*orgmode][Org Mode]]
- 1.2.8 [[*yamlmode][YAML Mode]]
- 1.2.9 [[*agimode][AGI Mode]]
- 2 [[*onsavereadmeorg][On save (README.org)]]
# END_TOC
